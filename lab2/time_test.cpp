...
// should be tested in a correct way to show that they are implemented correctly.
// Specifally check that the instance you called the operator on is modified.
//
